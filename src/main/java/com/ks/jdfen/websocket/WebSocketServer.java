...
public class WebSocketServer {
    ...
    public void onOpen(Session session, @PathParam("userId") String username) {
        ...
        try {
//            this.session.getBasicRemote().sendText(username+"加入！当前在线人数为" + getOnlineCount());
    ...
    public void onClose() {
        ...
        try {
//            this.session.getBasicRemote().sendText(this.username+"已退出！当前在线人数为" + getOnlineCount()+",分别是"+getAllNames());
